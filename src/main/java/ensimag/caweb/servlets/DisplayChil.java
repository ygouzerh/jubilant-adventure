 ...
 */
@WebServlet(name = "DisplayChil", urlPatterns = {"/DisplayChil"})
public class DisplayChil extends HttpServlet {
    
    public static final String DISPLAY_CHIL_VIEW  = "/WEB-INF/Liste_enfants.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher( DISPLAY_CHIL_VIEW ).forward( request, response );
    }
